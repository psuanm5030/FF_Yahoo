...
class Auth(object):
    ...
    def access(self):
        ...
        c = sanction.Client(auth_endpoint=self.all_creds['yahoo']['auth_uri'],
                     token_endpoint=self.all_creds['yahoo']['token_uri'],
                     client_id=self.all_creds['yahoo']['consumer_key'],
                     client_secret=self.all_creds['yahoo']['consumer_secret'])

        # Authorize and get the token
        auth_uri_r = c.auth_uri(redirect_uri=self.all_creds['yahoo']['callback_url'])
...
class db_Storage(object):
    ...
    def __init__(self, handler, which):
        self.db_creds = handler.all_creds[which]
...
class scoreboard_one(Base):
    ...
    T2_IS_OWNED_BY_CURRENT_LOGIN = Column(Float)
    ...
    T2_MANAGERS_MANAGER_IS_COMMISSIONER = Column(Float)
    T2_MANAGERS_MANAGER_IS_CURRENT_LOGIN = Column(Float)
    ...
    T1_CLINCHED_PLAYOFFS = Column(Float)
    ...
    T1_IS_OWNED_BY_CURRENT_LOGIN = Column(Float)
    ...
    T1_MANAGERS_MANAGER_IS_COMMISSIONER = Column(Float)
    T1_MANAGERS_MANAGER_IS_CURRENT_LOGIN = Column(Float)
...
class scoreboard_two(Base):
    ...
    DRAFT_POSITION = Column(String)
    HAS_DRAFT_GRADE = Column(String)
    IS_OWNED_BY_CURRENT_LOGIN = Column(Float)
    LEAGUE_SCORING_TYPE = Column(String)
    TEAM_LOGOS_TEAM_LOGO_MISSING_LOGO_SIZE = Column(String)
    MANAGERS_MANAGER_EMAIL = Column(String)
    ...
    MANAGERS_MANAGER_GUID = Column(String)
    MANAGERS_MANAGER_IMAGE_URL = Column(String)
    MANAGERS_MANAGER_IS_COMMISSIONER = Column(Float)
    MANAGERS_MANAGER_IS_CURRENT_LOGIN = Column(Float)
    MANAGERS_MANAGER_MANAGER_ID = Column(String)
    MANAGERS_MANAGER_NICKNAME = Column(String)
    NAME = Column(String)
    NUMBER_OF_MOVES = Column(Integer)
...
class player_weekly_stats(Base):
    ...
    # Define Columns
    id = Column(Integer, primary_key=True, autoincrement=True)
    BLOCK_KICK = Column(String)
    BYE_WEEKS_WEEK = Column(String)
    COMPLETIONS = Column(String)
    DISPLAY_POSITION = Column(String)
    DRAFT_GRADE = Column(String)
    DRAFT_RECAP_URL = Column(String)
    ...
    EXTRA_POINT_RETURNED = Column(String)
    FIELD_GOALS_0_19_YARDS = Column(String)
    FIELD_GOALS_20_29_YARDS = Column(String)
    FIELD_GOALS_30_39_YARDS = Column(String)
    FIELD_GOALS_40_49_YARDS = Column(String)
    FIELD_GOALS_50_YARDS = Column(String)
    FIELD_GOALS_MISSED_0_19_YARDS = Column(String)
    FIELD_GOALS_MISSED_20_29_YARDS = Column(String)
    FIELD_GOALS_MISSED_30_39_YARDS = Column(String)
    FIELD_GOALS_MISSED_40_49_YARDS = Column(String)
    FIELD_GOALS_MISSED_50_YARDS = Column(String)
    FUMBLE_RECOVERY = Column(String)
    FUMBLES_LOST = Column(String)
    ...
    NUMBER_OF_MOVES = Column(Integer)
    NUMBER_OF_TRADES = Column(Integer)
    OFFENSIVE_FUMBLE_RETURN_TD = Column(String)
    PASSING_TOUCHDOWNS = Column(String)
    PASSING_YARDS = Column(String)
    PLAYER_ID = Column(String)
    PLAYER_KEY = Column(String)
    PLAYER_POINTS_COVERAGE_TYPE = Column(String)
    PLAYER_POINTS_TOTAL = Column(String)
    ...
    POINT_AFTER_ATTEMPT_MISSED = Column(String)
    POINTS_ALLOWED = Column(String)
    POINTS_ALLOWED_0_POINTS = Column(String)
    POINTS_ALLOWED_14_20_POINTS = Column(String)
    POINTS_ALLOWED_1_6_POINTS = Column(String)
    POINTS_ALLOWED_21_27_POINTS = Column(String)
    POINTS_ALLOWED_28_34_POINTS = Column(String)
    POINTS_ALLOWED_35_POINTS = Column(String)
    POINTS_ALLOWED_7_13_POINTS = Column(String)
    POSITION_TYPE = Column(String)
    RECEIVING_TOUCHDOWNS = Column(String)
    RECEIVING_YARDS = Column(String)
    RECEPTIONS = Column(String)
    RETURN_TOUCHDOWNS = Column(String)
    RETURN_YARDS = Column(String)
    RUSHING_ATTEMPTS = Column(String)
    RUSHING_TOUCHDOWNS = Column(String)
    RUSHING_YARDS = Column(String)
    SACK = Column(String)
    ...
    TWO_POINT_CONVERSIONS = Column(String)
    UNIFORM_NUMBER = Column(String)
    URL = Column(String)
    WAIVER_PRIORITY = Column(String)
    WEEK = Column(Integer)
